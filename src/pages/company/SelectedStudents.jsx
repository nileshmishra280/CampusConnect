...
import { selectedStudentDetails } from '../../api/companyApi';
                        ...
                        <Card className="shadow-2xl rounded-2xl overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border border-white/20 dark:border-gray-700/30 transition-all duration-300">
                            <div className="p-4 sm:p-6 lg:p-8">
                                ...
                                <div className="block lg:hidden space-y-4">
                                    {students.map((student, index) => (
                                        <div key={index} className="bg-white dark:bg-gray-900/50 rounded-xl p-4 flex flex-col gap-4 border border-gray-100 dark:border-gray-700">
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-1 inline-block bg-gradient-to-r from-blue-500/10 to-indigo-500/10 dark:from-blue-600/20 dark:to-indigo-600/20 px-3 py-1 rounded-full">
                        ...
                        <div className="flex items-center justify-center py-16">
                            <div className="text-center">
                                <h2 className="text-xl sm:text-2xl font-semibold text-gray-700 dark:text-gray-200 mb-4">
                                    No students selected for this post!
                                </h2>
                            </div>
                        </div>
