  ...
  return (
    <>
      ...
      <div className={`min-h-screen transition-colors duration-300 ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
        ...
        <section className="px-4 py-1">
          <div className="container mx-auto flex flex-col items-center md:flex-row">
            ...
            <div className="md:w-1/2">
              <div className={`relative overflow-hidden rounded-xl shadow-2xl ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'}`}>
                <img
                  src="../../public/landing-bg.jpg"
                  alt="Recruitment Platform Interface"
                  className="w-full h-120 md:h-125 object-cover"
                  onError={() => console.log('Image failed to load')}
                />
                <div className="absolute right-0 bottom-0 left-0 bg-gradient-to-t from-black to-transparent p-6">
                  <p className="text-lg font-semibold text-white">Ready to kickstart your career?</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* CTA Section */}
        <section id="get-started" className="bg-purple-600 px-4 py-20">
          <div className="container mx-auto text-center">
            <h2 className="mb-6 text-3xl font-bold text-white">Ready to Transform Campus Recruitment?</h2>
            <p className="mx-auto mb-10 max-w-2xl text-xl text-purple-100">
              Join students, companies, and admins in revolutionizing the recruitment process. Start today!
            </p>
            <div className="flex flex-col justify-center space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
              <a
                href="/register"
                className="rounded-lg bg-white px-8 py-3 font-bold text-purple-600 transition-colors hover:bg-purple-50"
              >
                Create Free Account
              </a>
              <a
                href="#roles"
                className="rounded-lg border-2 border-white px-8 py-3 font-bold text-white transition-colors hover:bg-purple-700"
              >
                Explore Roles
              </a>
            </div>
