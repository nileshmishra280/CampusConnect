...
export default function CarouselTestimonial() {
  useEffect(() => {
    const slider = new Glide(".glide-testimonial", {
     ...
     breakpoints: {
        1024: { perView: 1 }, // Ensure only 1 slide on medium screens
        640: { perView: 1, gap: 8 }, // Tighter gap on small screens
      },
    }).mount();
          ...
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0 pb-12">
            <li>
              <div className="h-full w-full">
                <div className="h-full overflow-hidden rounded bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 shadow-lg shadow-purple-200 dark:shadow-purple-900">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          CampusConnect simplified our hiring process, allowing us to find top talent quickly and efficiently.
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-purple-600 dark:text-purple-500">
                        <span
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-purple-600 dark:text-purple-500">
                          <img
                          ...
                          <div className="flex flex-col gap-1">
                            <span className="font-bold uppercase">Sarah Johnson</span>
                            <cite className="not-italic">
                              <a href="#" className="hover:text-purple-800 dark:hover:text-purple-300">
                                HR Manager, TechCorp
                              </a>
                            </cite>
                          </div>
                ...
                <div className="h-full overflow-hidden rounded bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 shadow-lg shadow-purple-200 dark:shadow-purple-900">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          Applying to jobs through CampusConnect was a breeze, and I landed my dream role in no time!
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-purple-600 dark:text-purple-500">
                        <span
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-purple-600 dark:text-purple-500">
                          ...
                          />
                          <div className="flex flex-col gap-1">
                            <span className="font-bold uppercase">Arjun Patel</span>
                            <cite className="not-italic">
                              <a href="#" className="hover:text-purple-800 dark:hover:text-purple-300">
                ...
                <div className="h-full overflow-hidden rounded bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 shadow-lg shadow-purple-200 dark:shadow-purple-900">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-relaxed">
                        <p>
                          The automated verification feature in CampusConnect saved us countless hours during recruitment.
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-purple-600 dark:text-purple-500">
                        <span
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-purple-600 dark:text-purple-500">
                          ...
                          />
                          <div className="flex flex-col gap-1">
                            <span className="font-bold uppercase">Priya Sharma</span>
                            <cite className="not-italic">
                              <a href="#" className="hover:text-purple-800 dark:hover:text-purple-300">
                                Placement Officer
                              </a>
